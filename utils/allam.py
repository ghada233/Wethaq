...
class IBMWatsonXAIWrapper:
    def __init__(self, api_key, project_id, url, model_id="sdaia/allam-1-13b-instruct", max_new_tokens=400,
                 decoding_method="greedy", temperature=0.7, top_p=1, repetition_penalty=1.0, timeout=60):
...
def main():
    ...
    parser.add_argument("--url", default=os.getenv("IBM_WATSONX_URL", "https://eu-de.ml.cloud.ibm.com"),
                        help="IBM watsonX API URL")
    ...
    if not args.api_key or not args.project_id:
        print("""Error: API key and Project ID are required.
            Please provide them as arguments or set them in the .env file.""")
        return
